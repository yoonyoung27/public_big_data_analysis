...
④ Wrap the link text in brackets([]), and then wrap the link in parenthesis(()) to make links to other web sites ; [yoonyoung27](https://github.com/yoonyoung27/public_big_data_analysis)  
...
[my github code]: https://github.com/yoonyoung27/public_big_data_analysis
